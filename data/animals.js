...
function Mammal (name, lifespan, group, food, description, length, weigh, found, src) {
    this.name = name;
    this.lifespan = lifespan;
    this.group = group;
    this.food = food;
...
function Reptile (name, lifespan, group, food, description, length, weigh, found, src) {
        this.name = name;
        this.lifespan = lifespan;
        this.group = group;
        this.food = food;
    ...
    let Reptiles = [
        new Reptile("frill-necked-lizard", 
                "20 years", 
                "Reptile", 
